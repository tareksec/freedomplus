...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Freedom Plus | Free Learning Platform – Read Free Books, Articles & News" },
      { name: "twitter:description", content: "Freedom Plus is a free learning platform where everyone can read free books, explore educational articles, and stay updated with the latest news. Enjoy an ad-free reading experience and unlimited access to knowledge." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/3ebc6118-807d-4bd1-9ff8-db9f6b94f1d6" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/3ebc6118-807d-4bd1-9ff8-db9f6b94f1d6" },
    ],
    links: [
